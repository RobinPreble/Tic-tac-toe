...
import time
import random
"""In the middle of trying to make it so you can play again for 2 player mode, its not working theres
       probably a sneaky quit() somewhere.  After you fix that just polish it and remove all of the #quit()'s 
       and i think ur good"""
